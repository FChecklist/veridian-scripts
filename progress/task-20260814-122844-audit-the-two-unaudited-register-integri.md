...
## Remaining
- [ ] PR 360: extract named defect from its AUDIT:FAIL comment, implement real corrected fix, push, get a fresh independent audit citing new head (no self-certification)
