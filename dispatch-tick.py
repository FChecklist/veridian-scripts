...
def resume_interrupted_workers_tick(tasks):
    ...
    genuine race.
    """
    resumed, skipped_running, skipped_duplicate, flagged_stale = [], [], [], []
    for task_id, doc in tasks.items():
    ...
    return {"resumed": resumed, "skipped_running": skipped_running,
            "skipped_duplicate": skipped_duplicate, "flagged_stale": flagged_stale}
